...
let rec trans_obj : Sm5.obj -> Sonata.obj = function
	...
	| Sm5.Fn (arg, command) ->
	  	Sonata.Fn (arg, [Sonata.BIND "#currsf"] @ trans' command @
		[
			Sonata.PUSH (Sonata.Id "#currsf");
...
and trans' : Sm5.command -> Sonata.command = function
	...
	| Sm5.CALL :: cmds ->
		[
			Sonata.PUSH (Sonata.Fn ("#ta", (trans' cmds) @
				[
					Sonata.PUSH (Sonata.Id "#currsf");
					Sonata.PUSH (Sonata.Val (Sonata.Z 0));
					Sonata.MALLOC;
			...
			Sonata.BIND "#tempff";
			Sonata.BIND "#tl";
			Sonata.MALLOC; Sonata.BIND "#tvl"; Sonata.PUSH (Sonata.Id "#tvl"); Sonata.STORE;
			Sonata.BIND "#tf";
			Sonata.PUSH (Sonata.Id "#tempff");
			Sonata.PUSH (Sonata.Id "#tf"); Sonata.UNBIND; Sonata.POP;
			Sonata.PUSH (Sonata.Id "#tvl"); Sonata.LOAD; Sonata.UNBIND; Sonata.POP;
			Sonata.PUSH (Sonata.Id "#tl"); Sonata.UNBIND; Sonata.POP;
...
let trans : Sm5.command -> Sonata.command = fun command ->
	[Sonata.PUSH (Sonata.Fn ("#ta", [])); Sonata.BIND "#currsf"] @ trans' command
